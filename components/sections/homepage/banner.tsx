        ...
        <div className="m-auto max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
          ...
          <div className="relative flex flex-col items-center justify-center md:flex-row">
            <div className="w-80 md:w-auto">
              <a
                className="text-interactiveForegroundInversePrimary hover:text-interactiveForegroundPrimary mt-lg md:mt-none inline-flex h-16 w-full items-center justify-center whitespace-nowrap rounded-full bg-secondary px-12 py-5 text-base font-bold leading-normal transition-all duration-200 ease-in-out hover:bg-primary disabled:pointer-events-none disabled:opacity-50 md:w-fit"
                href="/start"
              >
                Start my approval
              </a>
              <div className="mt-3 flex items-center justify-center gap-1 text-sm text-primary-foreground">
                ...
                >
                  <path
                    ...
                    className="fill-primary-foretext-primary-foreground"
                  ></path>
                  <path
                    className="fill-primary-foretext-primary-foreground"
