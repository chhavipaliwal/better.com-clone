...
import { cn, Slider, Input as HeroInput } from '@heroui/react';
                ...
                <div className="grow">
                  <div className="w-full max-w-[300px]">
                    ...
                    <div className="relative z-0 w-full text-lg md:text-[40px]">
                      <input
                        className={cn(
                          'px-4 py-3 font-bold lg:text-5xl',
                          'max-w-[300px] rounded-small border border-foreground-200 transition-all hover:border-accent hover:shadow-[0_0_0_4px_inset] hover:shadow-accent focus:outline-none'
                        )}
                        name="homePrice"
                        type="tel"
